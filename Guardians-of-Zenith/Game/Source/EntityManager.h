...
public:
	...
	CombatEnemy naiadongoddess{ 2000,2000,400,20,11,1,300, 2, 3,"Naiadon goddess", "Lapis","Lucca", "Trident strike", 70, 0,0, "Tidalwave", 30, 1,0, "Ice blast", 50, 0,1, "Mystic water", 0, 2,0};
